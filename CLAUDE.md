...
**Font:** `DM Sans` via `google_fonts` package — applied globally through `GoogleFonts.dmSansTextTheme()` in `app_theme.dart`. All roles use DM Sans (w700 display, w600 headline/title, w400–w500 body/label). Never set fonts per-widget.
