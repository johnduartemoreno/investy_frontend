...
| 12b | KYC — Recoverable rejection (`retry`) | `/settings/kyc` | `kyc/presentation/screens/kyc_screen.dart` | `light_mode/12b_kyc_retry.png` | `dark_mode/12b_kyc_retry.png` |
| 12c | KYC — Final rejection | `/settings/kyc` | `kyc/presentation/screens/kyc_screen.dart` | `light_mode/12c_kyc_rejected.png` | `dark_mode/12c_kyc_rejected.png` |
